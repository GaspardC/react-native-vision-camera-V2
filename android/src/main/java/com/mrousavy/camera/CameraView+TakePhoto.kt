...
suspend fun CameraView.takePhoto(options: ReadableMap): WritableMap =
  coroutineScope {
    ...
    val captureCallback =
      object : CameraCaptureSession.CaptureCallback() {
        override fun onCaptureCompleted(
          ...
          Log.d("Camera2", "Exposure Time: $exposureTime, Aperture: $aperture, ISO: $iso")
        }
      }
