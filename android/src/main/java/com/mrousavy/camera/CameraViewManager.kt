...
class CameraViewManager(reactContext: ReactApplicationContext) : ViewGroupManager<CameraView>() {
  ...
  fun setEnableHighQualityPhotos(
    view: CameraView,
  ...
  fun setEnablePortraitEffectsMatteDelivery(
    view: CameraView,
  ...
  fun setFrameProcessorFps(
    view: CameraView,
    frameProcessorFps: Double,
  ) {
  ...
  companion object {
    ...
    private fun addChangedPropToTransaction(
      view: CameraView,
      changedProp: String,
    ) {
